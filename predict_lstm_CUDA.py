...
for index in range(5):
    # with open("./data/7/AUC_result_lstm_polynomial_eff_pro.txt", "a") as f:
    with open("./data/7/AUC_result_lstm_node_eff_pro.txt", "a") as f:
    # with open("./data/7/AUC_result_lstm_node_is_fail.txt", "a") as f:
        f.write(str(index+1)+'\n')
        max_AUC = 0
